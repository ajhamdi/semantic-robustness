...
# python map.py --all_shapes=0 --class_nb=0 --object_nb=0 --precisions=3 --override=1 --custom_shapes=0

python test.py --network=resnet --is_weight_learning=0 --is_shape_features=1 --is_initial_point=1 --network_depth=4  --iterations=150 --cluster_exp=0