...
python test.py --network=resnet --is_weight_learning=0 --is_shape_features=1 --is_initial_point=1 --network_depth=4  --iterations=150 --cluster_exp=${SLURM_ARRAY_TASK_ID}
