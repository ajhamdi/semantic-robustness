...
python main.py --exp_type="Adversarial" --scenario_nb=$((1+${SLURM_ARRAY_TASK_ID}))  --is_randomize=True --dataset_nb=4 --evolution_nb=1 --task_nb=${SLURM_ARRAY_TASK_ID} --valid_size=250 --log_frq=1000 --batch_size=128 --K=10 --induced_size=1000 --retained_size=5000 --ind_frq=4 --nb_steps=400 --gendist_size=20000 --is_train=True --is_gendist=False --is_cluster=True --is_visualize=True --cont_train=False --optimize_oracle=False --restore_all=False --is_focal=False --is_evolve=False --keep_bank=False --full_set=True  > /dev/null
