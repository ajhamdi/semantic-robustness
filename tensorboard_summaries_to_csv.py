...
def main(root, tags_filename, csv_filename, append_cvs_filename):
    with open(tags_filename, 'r') as fobj:
        tags = json.load(fobj)

    rows = []
    for experiment_foldername in tqdm(glob.glob('{}/*'.format(root))):
...
if __name__ == '__main__':
    ...
    parser.add_argument('-o', '--csv_filename',default='scores.csv', type=str,
